...
from company_blog.main.forms import (
    BlogCategoryForm,
    UpdateCategoryForm,
    BlogPostForm,
    BlogSearchForm,
...
from company_blog.main.image_hundler import add_featured_image
...
def category_maintenance():
    ...
    blog_category = BlogCategory.query.order_by(BlogCategory.id.asc()).paginate(
    ...
    return render_template(
        "category_maintenance.html", blog_category=blog_category, form=form
    )
...
def create_post():
    ...
    if form.validate_on_submit():
        ...
        blog_post = BlogPost(
            ...
            text=form.text.data,
            featured_image=form.picture.data,
